...
public class StudyListBox {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//table[@name='courses']//tr[3]/td[2]"));
		...
		{
		String header =driver.findElement(By.xpath("//table[@name='courses']/tbody/tr[1]/th["+i+"]")).getText();System.out.print(header+" ");
		}
		System.out.println();
		//outer for loop--> row
		for(int i=2;i<=totalNumberOfRows;i++)
